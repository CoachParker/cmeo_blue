...
class PersonController extends Controller
{
	...
	{
		$model=Person::model()->with('entities')->findByPk($id);
		if($model===null)
	...
	protected function performAjaxValidation($model)
	{
        ...
        {
            $person=Person::model()->with('entities')->findByPk($id);
            #$person=Person::model()->findAll();
            #$entitys=$person->entities->Name; #trying to get property of non-object
            $entitys=$person->entities;
            //
            #$array=$person->entities;
            #$entity=implode(",",$array); #Object of class Entity could not be converted to string
            /*
            $entitys='';
